...
class GeoLocation {
   ...
   */
    ...
    public static function getRhumbLineBearing(GeoLocation $location1, GeoLocation $location2) {
        $lat1 = $location1 -> degLat;
        $lon1 = $location1 -> degLon;
        $lat2 = $location2 -> degLat;
        $lon2 = $location2 -> degLon;
        ...
        return ((rad2deg(atan2($dLon, $dPhi)) + 180) % 360);
   }
}